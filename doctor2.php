...
<div class="container" style="margin-top: 1%;margin-bottom: 1%;">
  <h1 style="text-align: center;">Doctor List To Register</h1>
  <div class="row">
  <?php
   ...
   <div class="col-sm-12 col-md-3">
      <div class="card" style="width:20rem;margin-bottom: 4%;">
        ...
        <div class="card-body">
          ...
          <p class="card-text">Price- <?php echo $row['dprice']; ?></p>
          <p class="card-text">Time- <?php echo $row['dtime']; ?></p>
          <p class="card-text">Date- <?php echo $row['ddate']; ?></p>
          
            <button class="openbtn btn btn-outline-info" onclick="openNav()">Book Now</button>
...
<tr>
<td width="50"><div align="center"><strong>Name</strong></div></td>
        <td width="100"><div align="left"><strong>Email</strong></div></td>
        <td width="100"><div align="left"><strong>Doctor Name</strong></div></td>
        <td width="150"><div align="center"><strong>Message</strong></div></td>
</tr> 
<?php
      
      //$transnum=$_GET['transnum'];
      $result3 = mysql_query("SELECT * FROM feedback WHERE fid='$fid'");
      //$result3 = mysql_query("SELECT * FROM orders");
      
        while($row3 = mysql_fetch_array($result3))
          {
          echo '<tr>';
          echo '<td><div align="center"><a href="deleteorder.php?orderid='.$row3['fid'].'" fid="'.$row3['fid'].'" class="delbutton" title="Click To Delete"><img src="shoppingcard/image/delete.png" width="20%" height="20%"></a></div></td>';
          echo '<td><div align="left">'.$row3['name'].'</div></td>';
          echo '<td><div align="right">'.$row3['email'].'</div></td>';
          echo '<td><div align="right">'.$row3['dname'].'</div></td>';
          echo '<td><div align="right">'.$row3['message'].'</div></td>';
          echo '</tr>';
          }
      ?>

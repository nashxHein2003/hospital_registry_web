  ...
  <div class="d-flex" id="wrapper">
    ...
    <div class="bg-light border-right" id="sidebar-wrapper">
      ...
      <div class="list-group list-group-flush">
       ...
       <a href="orderlist.php" class="list-group-item active list-group-item-action bg-secondary">Order List<sup>
                    <span class="badge" style="background-color:tomato;font-size: 1.2em;">
                       
                         <?php
                         include("database.php");
                        $result1 = mysql_query("SELECT * FROM sell order by selldate DESC");
...
<th class="text-center">Grand Total</th>
 ...
 <?php
 include("database.php");
 $result = mysql_query("SELECT * FROM sell");
 ?>

  ...
  <div class="d-flex" id="wrapper">
    ...
    <div class="bg-light border-right" id="sidebar-wrapper">
      ...
      <div class="list-group list-group-flush">
        ...
        <a href="viewdoctor.php" class="list-group-item active list-group-item-action bg-secondary">View Doctor</a>
...
center">
 ...
 <th class="text-center">Doctor Degree</th>
 <th class="text-center">Doctor Description</th>
 <th class="text-center">Doctor Price</th>
 <th class="text-center">Patient Check-in Time</th>
 ...
 <tr>
 <td class="pt-3-half" contenteditable="disable"><?php echo $row['dname']; ?></td>
 <td class="pt-3-half" contenteditable="true"><?php echo $row['ddegree']; ?></td>
 <td class="pt-3-half" contenteditable="true"><?php echo $row['ddescription']; ?></td>
 <td class="pt-3-half" contenteditable="true"><?php echo $row['dprice']; ?></td>
 <td class="pt-3-half" contenteditable="true"><?php echo $row['starttime']; ?></td>
  <td class="pt-3-half" contenteditable="true"><?php echo $row['endtime']; ?></td>
   <td class="pt-3-half" contenteditable="true"><?php echo $row['dphoto']; ?></td>
 <td>
 <span class="table-remove"><a
href="deletedoctor.php?id=<?=$row['did'];?>"><button
type="button" class="btn btn-danger btn-rounded btn-sm
my-0">Delete</button></a></span>
 <span class="table-remove"><a
href="editdoctor.php?id=<?=$row['did'];?>"><button

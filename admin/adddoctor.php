  ...
  <div class="d-flex" id="wrapper">
    ...
    <div class="bg-light border-right" id="sidebar-wrapper">
      ...
      <div class="list-group list-group-flush">
        <a href="adddoctor.php" class="list-group-item active list-group-item-action bg-secondary">Add Doctor</a>
    ...
    <div id="page-content-wrapper">
      ...
      <form action="adddoctorprocess.php" method="post">
...
<input type="time" class="form-control" required="required" name="starttime">

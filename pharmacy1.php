...
<div class="container-fluid">
  <div class="row">
    <div class="row">
    <div class="col-8"><h1 >Pharmacy Center</h1>
    ...
    <div class="col-4" ><img src="image/pharmacycenter.jpg"></div>
  </div>
...
<div class="container" style="margin-top: 1%;margin-bottom: 1%;">
  ...
  $filter=$_GET['filter'];
    ...
    $result = mysql_query("SELECT * FROM pharmacy where pname like '%$filter%'");
   ?>
